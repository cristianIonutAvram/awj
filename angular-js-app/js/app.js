...
app.controller('StudentController', ['$scope', '$http', function($scope, $http) {
  ...
  app.controller('MaterieController', ['$scope', '$http', function($scope, $http) {
   
   var url = "http://localhost:8080/materie";
  ...
  app.controller('FacultateController', ['$scope', '$http', function($scope, $http) {
   
   var url = "http://localhost:8080/facultate";
...
app.controller('ProfesorController', ['$scope', '$http', function($scope, $http) {
